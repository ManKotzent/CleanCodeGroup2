...
public class CrawlerRecordFactoryTest {
     ...
     class generateCrawlerRecordTest {
         ...
         public void test() throws InterruptedException{
             CrawlerRecordFactory crf = new CrawlerRecordFactory("https://www.vitsoe.com/us/about/good-design", 1);
             crf.start();
             crf.join();

             CrawlerRecord cr = crf.getRecord();
             System.out.println(cr.toFormattedString());
         }
     }
}
